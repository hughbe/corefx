...
namespace System.ComponentModel
{
    ...
    public class UInt64Converter : BaseNumberConverter
    {
        ...
        /// </summary>
        private protected override Type TargetType => typeof(ulong);

        /// <summary>
        /// Convert the given value to a string using the given radix
        /// </summary>
        private protected override object FromString(string value, int radix) => Convert.ToUInt64(value, radix);
