...
namespace System.ComponentModel
{
    ...
    public class UInt16Converter : BaseNumberConverter
    {
        ...
        /// </summary>
        private protected override Type TargetType => typeof(ushort);

        /// <summary>
        /// Convert the given value to a string using the given radix
        /// </summary>
        private protected override object FromString(string value, int radix) => Convert.ToUInt16(value, radix);
