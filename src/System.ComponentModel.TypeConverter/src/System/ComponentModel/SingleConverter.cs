...
namespace System.ComponentModel
{
    ...
    public class SingleConverter : BaseNumberConverter
    {
        ...
        /// </summary>
        private protected override Type TargetType => typeof(float);

        /// <summary>
        /// Convert the given value to a string using the given radix
        /// </summary>
        private protected override object FromString(string value, int radix) => Convert.ToSingle(value, CultureInfo.CurrentCulture);
