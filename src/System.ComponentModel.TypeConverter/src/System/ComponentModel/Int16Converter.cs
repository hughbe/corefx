...
namespace System.ComponentModel
{
    ...
    public class Int16Converter : BaseNumberConverter
    {
        ...
        /// </summary>
        private protected override Type TargetType => typeof(short);

        /// <summary>
        /// Convert the given value to a string using the given radix
        /// </summary>
        private protected override object FromString(string value, int radix) => Convert.ToInt16(value, radix);
