...
namespace System.CodeDom.Compiler.Tests
{
    public class CSharpCodeGeneratorTests
    {
        ...
        {
            ICodeGenerator generator = GetGenerator();
            Assert.Throws<ArgumentNullException>("value", () => generator.CreateEscapedIdentifier(null));
        }
        ...
        {
            ICodeGenerator generator = GetGenerator();
            Assert.Throws<ArgumentNullException>("value", () => generator.CreateValidIdentifier(null));
        }
        ...
        {
            ICodeGenerator generator = GetGenerator();
            Assert.Throws<ArgumentException>("e", () => generator.GenerateCodeFromExpression(e, new StringWriter(), new CodeGeneratorOptions()));
        }
        ...
        {
            ICodeGenerator generator = GetGenerator();
            Assert.Throws<ArgumentException>("e", () => generator.GenerateCodeFromStatement(e, new StringWriter(), new CodeGeneratorOptions()));
        }
...
"
            ...
            yield return new object[] { CreateType(singleTypeParameterMethod), null, $"public class type {{{nl}    {nl}    private returnType name<typeParameter>(){nl}     {{{nl}    }}{nl}}}{nl}" };
...
"
            ...
            yield return new object[] { singleTypeParameterType, null, $"public class name<name>{nl} {{{nl}}}{nl}" };
            ...
            yield return new object[]
            {
                ...
                null,
                $"#pragma checksum \"\" \"{{00000000-0000-0000-0000-000000000000}}\" \"\"{nl}#pragma checksum \"startFileName\" \"{{00000001-0002-0003-0405-060708090a0b}}\" \"\"{nl}#pragma checksum \"startFileName\" \"{{00000001-0002-0003-0405-060708090a0b}}\" \"010203\"{nl}#region {nl}#region startText{nl}#endregion{nl}#endregion{nl}#region {nl}#region startText{nl}" +
                $"// {nl}// comment1{nl}/// comment2{nl}{nl}#line 1 \"fileName\"{nl}" +
                $"[()]{nl}[name1()]{nl}[name2(1)]{nl}[name3(arg1=1, arg2=2)]{nl}[@is(@as=1, arg2=2)]{nl}public class name<, name, [attribute()]  name, name, name, [()] [name1()] [name2(1)] [name3(arg1=1, arg2=2)] [@is(@as=1, arg2=2)]  name> : void, baseType, @as{nl}{nl}{nl}{nl}    where name : new(){nl}    where name : constraint{nl}    where name : void, constraint, @as, new () {{{nl}}}{nl}" +
                $"{nl}#line default{nl}#line hidden{nl}" +
                $"#pragma checksum \"\" \"{{00000000-0000-0000-0000-000000000000}}\" \"\"{nl}#pragma checksum \"startFileName\" \"{{00000001-0002-0003-0405-060708090a0b}}\" \"\"{nl}#pragma checksum \"startFileName\" \"{{00000001-0002-0003-0405-060708090a0b}}\" \"010203\"{nl}#region {nl}#region startText{nl}#endregion{nl}#endregion{nl}#region {nl}#region startText{nl}"
            };
        ...
        public void GenerateCodeFromType_Invoke_Success(CodeTypeDeclaration e, CodeGeneratorOptions o, string expected)
        {
            ...
            AssEq(expected, writer.ToString());
        }
        
        public void AssEq(string expected, string actual)
        {
            try
            {
            ...
            catch (Xunit.Sdk.AssertActualExpectedException)
            {
                string Normalize(string s)
                {
                    ...
                    return s
                        ...
                        .Replace("#line 1 \\\"fileName\\\"{nl}", $"#line 1 \\\"fileName\\\"{{nl}}\" +{Environment.NewLine}$\"")
                        .Replace("#region startText{nl}//", $"#region startText{{nl}}\" +{Environment.NewLine}$\"//")
                        .Replace("{nl}#line default", $"\" +{Environment.NewLine}$\"{{nl}}#line default")
                        .Replace("#line hidden{nl}", $"#line hidden{{nl}}\" +{Environment.NewLine}$\"");
                    */
                }
        ...
        public static IEnumerable<object[]> GenerateCodeFromType_NullE_TestData()
        {
            yield return new object[] { null };
        }

        [Theory]
        [MemberData(nameof(GenerateCodeFromType_NullE_TestData))]
        public void GenerateCodeFromType_NullE_ThrowsArgumentNullException(CodeStatement e)
        {
            ICodeGenerator generator = GetGenerator();
            Assert.Throws<ArgumentNullException>("e", () => generator.GenerateCodeFromStatement(e, new StringWriter(), new CodeGeneratorOptions()));
        }
        ...
        {
            ICodeGenerator generator = GetGenerator();
            Assert.Throws<ArgumentException>("e", () => generator.GenerateCodeFromType(e, new StringWriter(), new CodeGeneratorOptions()));
        }
