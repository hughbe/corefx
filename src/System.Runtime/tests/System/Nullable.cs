...
namespace System.Runtime.Tests
{
    public static class NullableTests
    {
        ...
        public static IEnumerable<object[]> EqualsCompareTestData()
        {
        ...
        [Theory, MemberData("EqualsCompareTestData")]
        public static void TestCompareAndEquals(int? n1, int? n2, int expected)
        {
