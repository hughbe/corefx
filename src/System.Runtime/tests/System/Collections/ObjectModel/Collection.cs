...
namespace System.Collections.ObjectModel.Tests
{
    ...
    public class CollectionTests : CollectionTestBase
    {
        ...
        public static void Indexer()
        {
            ...
            Assert.Throws<ArgumentOutOfRangeException>(() => collection[-1]); // Index < 0
            Assert.Throws<ArgumentOutOfRangeException>(() => collection[s_intArray.Length]); // Index >= collection.Count
            Assert.Throws<ArgumentOutOfRangeException>(() => s_empty[0]); // Index >= collection.Count

            Assert.Throws<ArgumentOutOfRangeException>(() => collection[-1] = 0); // Index < 0
            Assert.Throws<ArgumentOutOfRangeException>(() => collection[s_intArray.Length] = 0); // Index >= collection.Count
        }
        ...
        public static void IndexerSetInvalidType()
        {
            ...
            Assert.Throws<ArgumentException>(() => ((IList)collection)[1] = "Two"); // Object type is not an int
        }
