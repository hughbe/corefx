...
{
    public static class WeakReferenceTests
    {
        ...
        public static void TestNonGeneric()
        {
            ...
            VerifyStillAlive(w);
            Assert.True(ReferenceEquals(o1, w.Target));
            ...
            w.Target = o2;
            VerifyStillAlive(w);
            Assert.True(ReferenceEquals(o2, w.Target));
            GC.KeepAlive(o2);
        ...
        public static void TestGeneric()
        {
            ...
            Assert.True(ReferenceEquals(v1, o1));
            GC.KeepAlive(o1);
            ...
            Assert.True(ReferenceEquals(v2, o2));
            GC.KeepAlive(o2);
