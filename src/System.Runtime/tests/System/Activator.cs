...
namespace System.Runtime.Tests
{
    public static class ActivatorTests
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => Activator.CreateInstance(null)); // Type is null
            Assert.Throws<ArgumentNullException>(() => Activator.CreateInstance(null, new object[0])); // Type is null
