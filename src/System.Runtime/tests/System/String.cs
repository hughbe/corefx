...
namespace System.Runtime.Tests
{
    public static class StringTests
    {
        ...
        [Fact]
        public static unsafe void TestCtorCharPtr()
        {
        ...
        [Fact]
        public static unsafe void TestCtorCharPtrIntInt()
        {
            string s;
            char[] c = { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', '\0' };
            fixed (char* pc = c)
        ...
        [InlineData("$$", new object[] { null, "Bar", "Baz" }, "")] // Overload exits if [0] is null
        ...
        [InlineData("11111111111111111111111", "1", "11", "1111111111111111111111111111111111111111111111")] // Check if we handle the max # of matches
