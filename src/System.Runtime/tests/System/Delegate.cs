...
namespace System.Runtime.Tests
{
    public static class DelegateTests
    {
        ...
        public static void TestDynamicInvoke_AllowsPrimitiveWidening()
        {
            ...
            d = new DFoo1(Foo1);
            Assert.Throws<ArgumentException>(() => d.DynamicInvoke(new object[] { 7, (uint)7 }));
            
            d = new DFoo1(Foo1);
            Assert.Throws<ArgumentException>(() => d.DynamicInvoke(new object[] { 7, U4.Seven }));
        }
        ...
        public static void TestDynamicInvoke_AllowsNullableConversion()
        {
            ...
            d = new DFoo6(Foo6);
            Assert.Throws<ArgumentException>(() => d.DynamicInvoke(new object[] { (short)7 }));

            d = new DFoo6(Foo6);
            Assert.Throws<ArgumentException>(() => d.DynamicInvoke(new object[] { E4.Seven }));
        }
